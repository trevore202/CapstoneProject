...
<c:if test="${role.equals('customer')}">
${name}, please enter the shipping address and email for this order<br/><br/>

<form method='post'>
	<label>Shipping Address</label>
	<div class='input-group mb-3'>
		<input class="form-control" type="text" name='shippingaddress' placeholder="Enter Address...">
	</div>
